...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        // Inserir cliente
        $stmt = $pdo->prepare("INSERT INTO clientes (nome, email, telefone, cpf, cep, endereco, bairro, numero, plano, data_vencimento, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'ativo')");
        $stmt->execute([$nome, $email, $telefone, $cpf, $cep, $endereco, $bairro, $numero, $plano, $data_vencimento]);
...
<head>
    ...
    <title>Cadastro de Cliente - Portal Cegonheiro</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="cadastro_cliente.php" class="menu-item active">
        ...
        <div class="page-header">
            <div>
                <div class="breadcrumb-nav">
                    <strong>HOME</strong> > Dashboard > Cadastro de Cliente
                </div>
                ...
                <form method="POST" id="cadastroForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" name="plano" id="plano" required>
                                ...
                                <option value="intermediario">Intermediário - R$ 199/mês</option>
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-building"></i> Cadastrar Cliente
                        </button>
